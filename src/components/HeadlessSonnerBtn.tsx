...
export default function HeadlessSonnerBtn() {
  return (
    <button
      className="relative flex h-10 w-24 flex-shrink-0 items-center justify-center gap-2 overflow-hidden rounded-full px-4 text-sm font-medium shadow-sm transition-all bg-[#FCF8F7] hover:bg-[#f7f4f3] dark:bg-[#161615] dark:hover:bg-[#1A1A19] dark:text-[#FCF8F7]"
      onClick={() => {
        toast({
